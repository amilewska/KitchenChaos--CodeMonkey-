    ...
    public string GetBindingText(Binding binding)
    {
        switch (binding)
        {
            ...
            case Binding.InteractAlternate:
                return playerInputActions.Player.InteactAlternate.bindings[0].ToDisplayString();
            case Binding.Pause:
            ...
            case Binding.Gamepad_InteractAlternate:
                return playerInputActions.Player.InteactAlternate.bindings[1].ToDisplayString();
    ...
    public void RebindBinding(Binding binding, Action onActionRebound)
    {
        ...
        switch (binding)
        {
            ...
            case Binding.Interact:
                ...
                break;
            case Binding.InteractAlternate:
                inputAction = playerInputActions.Player.InteactAlternate;
                bindingIndex = 0;
                break;
            case Binding.Pause:
